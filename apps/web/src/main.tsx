...
function App() {
  ...
  return (
    <main className="site-shell">
      ...
      <p className="boundary">Current boundary: authenticated live Scottish Parliament API access only. CLD does not retain source data or provide datasets, downloads, charts, or research releases.</p>
    </main>
  );
}
