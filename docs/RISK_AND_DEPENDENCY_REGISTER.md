...
| --- | --- | --- | --- | --- | --- | --- |
| RSK-0001 | Risk | Draft methodology could be treated as implementation approval. | High | Project owner | Before any work outside documentation. | Confirm a specific scope and record explicit approval. |
...
| DEP-0001 | Dependency | Approval of the project-design draft and a bounded first source slice. | High | Project owner | Before any source/infrastructure/application proposal. | Resolve DEC-0006 and DEC-0007. |
