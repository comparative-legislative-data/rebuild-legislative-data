...
| DEP-0003 | Dependency | Approved deployment and secret-management approach. | High | Project owner | Before V4 provisioning, database/service creation, secret issuance, deployment, or application implementation. | DEC-0009 proposal is ready. Approval must select the current-VPS, no-Docker isolation model and its secret-management rules before a separate exact V4 proposal. |
