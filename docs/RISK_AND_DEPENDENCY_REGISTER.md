...
| DEP-0001 | Dependency | A completed bounded reconnaissance assessment, followed by owner approval of a bounded first source slice and its success criteria. | High | Project owner | Before any capture/infrastructure/application proposal. | Complete DEC-0013 within its limits, then resolve DEC-0007 before a capture proposal. |
