...
| DEP-0003 | Dependency | Approved deployment and secret-management approach. | High | Project owner | Before V4 provisioning, database/service creation, secret issuance, deployment, or application implementation. | Satisfied by DEC-0009 and DEC-0022. DEC-0023 remains required before any foundation mutation; later V4B/V4C actions require their own exact authorisations. |
