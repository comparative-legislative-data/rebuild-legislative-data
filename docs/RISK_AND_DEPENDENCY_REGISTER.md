...
| DEP-0001 | Dependency | Owner approval of a bounded reconnaissance action, followed by a bounded first source slice and its success criteria. | High | Project owner | Before source inspection and before any capture/infrastructure/application proposal. | Resolve DEC-0013 before reconnaissance and DEC-0007 before a capture proposal. |
