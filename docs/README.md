...
| [Data — GB-SCT](data/gb-sct/) | Source scope, endpoint inventory, transparent pass-through, DB1, DB2, retention, and control templates. | [Master endpoint delivery matrix](data/gb-sct/GB_SCT_MASTER_ENDPOINT_DELIVERY_MATRIX_DEC0045.md), [Bills-family gap-resolution plan](data/gb-sct/GB_SCT_BILLS_FAMILY_QUALIFICATION_GAP_RESOLUTION_PROPOSAL_DEC0050.md), [blocked documentation-inspection result](data/gb-sct/GB_SCT_BILLS_OFFICIAL_DOCUMENTATION_INSPECTION_RESULT_2026-08-02.md), and [proposed recovery](data/gb-sct/GB_SCT_BILLS_OFFICIAL_DOCUMENTATION_RECOVERY_PROPOSAL_DEC0052.md) |
...
| [Application](application/) | V4B application specification, local implementation, deployment, acceptance evidence, and private-beta controls. | [Private beta access foundation](application/PRIVATE_BETA_ACCESS_FOUNDATION_PROPOSAL_DEC0043.md) and [pilot access-flow reconnaissance](application/PILOT_ACCESS_FLOW_RECONNAISSANCE_2026-08-02.md) |
