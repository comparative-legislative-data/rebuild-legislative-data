...
| [Data — GB-SCT](data/gb-sct/) | Source scope, endpoint inventory, transparent pass-through, DB1, DB2, retention, and control templates. | [Master endpoint delivery matrix](data/gb-sct/GB_SCT_MASTER_ENDPOINT_DELIVERY_MATRIX_DEC0045.md) and [Bills collection observation result](data/gb-sct/GB_SCT_BILLS_COLLECTION_OBSERVATION_RESULT_2026-08-02.md) |
