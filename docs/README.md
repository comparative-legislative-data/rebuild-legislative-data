...
| DB1 source-faithful projection | Capture approved source responses with manifests and create a reproducible operational projection with capture lineage. | D1/D2/D3 passed; D4A bounded reference-cohort reconciliation pilot proposed for owner review. | [DB1 narrative](workstreams/db1/README.md) |
