...
| [Data — GB-SCT](data/gb-sct/) | Source scope, endpoint inventory, transparent pass-through, DB1, DB2, retention, and control templates. | [Three-layer programme](data/gb-sct/GB_SCT_TRANSPARENT_ACCESS_DB1_DB2_PROGRAMME_PROPOSAL_DEC0042.md) and [Bills terms qualification proposal](data/gb-sct/GB_SCT_BILLS_ROUTE_QUALIFICATION_AND_SOURCE_TERMS_PROPOSAL_DEC0044.md) |
...
| [Application](application/) | V4B application specification, local implementation, deployment, acceptance evidence, and proposed private-beta controls. | [Private beta access proposal](application/PRIVATE_BETA_ACCESS_FOUNDATION_PROPOSAL_DEC0043.md) |
