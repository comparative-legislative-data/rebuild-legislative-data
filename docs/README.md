...
| DB1 source-faithful projection | Capture approved source responses with manifests and create a reproducible operational projection with capture lineage. | D1/D2/D3/D4A passed; three small reference collections now have a bounded daily reconciliation service. | [DB1 narrative](workstreams/db1/README.md) |
