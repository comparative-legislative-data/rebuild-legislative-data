...
The current DB1 coverage is recorded in the [coverage snapshot](GB_SCT_DB1_COVERAGE_SNAPSHOT_2026-08-04.md).
...
and its limits are in the [high-volume route audit](../../archive/data/gb-sct/reconnaissance/GB_SCT_HIGH_VOLUME_ROUTE_AUDIT_RESULT_2026-08-02.md)
and the [high-volume operational register](GB_SCT_HIGH_VOLUME_OPERATIONAL_REGISTER_2026-08-03.md).
