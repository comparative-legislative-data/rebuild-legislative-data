...
**Status:** `PASS — DEC-0088 CLOSED; OWNER ACCEPTED`
**Date:** 4 August 2026
**Decision:** DEC-0088
...
as expected: **DB1 catalogue** → **Parties and government roles** → **Party
roles collection**. This accepted the two retained releases in one group, the
retained-DB1/proxy distinction, provenance, observed structure, limits denying
party membership or role-history meaning, and fixed paging. No detail route,
parties/member relationship route, download, generic search/filter, or DB2
...
is required on D9 failure/change/drift, a proposed access or projection change,
