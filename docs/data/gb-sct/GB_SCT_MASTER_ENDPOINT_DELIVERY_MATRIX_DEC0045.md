...
| MQA motions | `/api/motionsquestionsanswersmotions` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_VOLUME_PROFILE_PASS_DEC0055; HANDLING_REQUIRED` |
...
| MQA business motions | `/api/MotionsQuestionsAnswersMotionsBusiness?motionfilter=programme` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_VOLUME_PROFILE_PASS_DEC0055; HANDLING_REQUIRED` |
...
| Votes on motions | `/api/votesmotion/:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_BILL_AMENDMENT_OR_STAGE_VOTE_CLAIM` | `P4` | `DETAIL_PENDING; HANDLING_REQUIRED` |
