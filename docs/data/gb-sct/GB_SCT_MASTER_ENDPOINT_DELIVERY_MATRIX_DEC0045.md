...
| Committees | `/api/committees` | `INTENDED_AFTER_QUALIFICATION` | `D12_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0091` | `CANDIDATE_T1`; no membership/assignment inference | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0091; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0091; DAILY_TIMER_D12; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
