...
| MQA questions | `/api/motionsquestionsanswersquestions?year=:year` | `PROPOSED_D17_DEC0096` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `YEAR_FORM_FULL_RESPONSE_AUDIT_PASS_DEC0055; ROUTE_SPECIFIC_8_MIB_60_SECOND_GATE_PROPOSED_DEC0096; OWNER_APPROVAL_REQUIRED` |
...
| Votes on motions | `/api/votesmotion?year=:year` | `PROPOSED_D17_DEC0096` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_BILL_AMENDMENT_OR_STAGE_VOTE_CLAIM` | `P4` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; ROUTE_SPECIFIC_24_MIB_90_SECOND_GATE_PROPOSED_DEC0096; OWNER_APPROVAL_REQUIRED; NO_BILL_AMENDMENT_OR_STAGE_VOTE_CLAIM` |
