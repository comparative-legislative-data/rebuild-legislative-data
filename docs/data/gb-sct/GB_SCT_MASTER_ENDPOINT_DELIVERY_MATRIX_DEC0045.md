...
| Parties | `/api/parties` | `INTENDED_AFTER_QUALIFICATION` | `D10_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PROPOSED_DEC0089` | `CANDIDATE_T1` source-defined party terminology only; no affiliation, validity, or party-history claim | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_PROPOSED_DEC0089; NO_DETAIL_OR_RELATIONSHIP_ROUTE` |
