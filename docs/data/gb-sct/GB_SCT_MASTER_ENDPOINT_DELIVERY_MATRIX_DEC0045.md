...
| Committees | `/api/committees` | `INTENDED_AFTER_QUALIFICATION` | `D12_PROPOSED_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_DEC0091` | `CANDIDATE_T1`; no membership/assignment inference | `P2` | `OBSERVATION_PASS_DEC0055; ROUTE_HANDLING_DEFAULT_DO_NOT_CAPTURE_OR_RELEASE; D12_OWNER_APPROVAL_REQUIRED; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
