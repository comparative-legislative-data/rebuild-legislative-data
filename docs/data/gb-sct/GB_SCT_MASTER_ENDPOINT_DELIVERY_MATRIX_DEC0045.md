...
| Votes on motions | `/api/votesmotion?year=:year` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_BILL_AMENDMENT_OR_STAGE_VOTE_CLAIM` | `P4` | `YEAR_FORM_PROFILE_PASS_DEC0055; HANDLING_REQUIRED` |
