...
| Parties | `/api/parties` | `INTENDED_AFTER_QUALIFICATION` | `D10_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0089` | `CANDIDATE_T1` source-defined party terminology only; no affiliation, validity, or party-history claim | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0089; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0089; DAILY_TIMER_D10; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_ROUTE` |
