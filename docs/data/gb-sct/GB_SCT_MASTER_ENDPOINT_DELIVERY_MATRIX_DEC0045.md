...
| Formal stages | `/api/billstages` | `INTENDED_AFTER_QUALIFICATION` | `D5_RESTRICTED_CAPTURE_AND_ACCESS_PLAN_PASS_OWNER_ACCEPTED_DEC0083` | `CANDIDATE_T1`; possible `CANDIDATE_T2` ordering only after rules | `P1` | `OBSERVATION_PASS; RESTRICTED_HANDLING_DEC0083; ONE_NO_QUERY_CAPTURE_DEC0083; DAILY_RECONCILIATION_D5; ACCESS_PLAN_FIRST; PRIVATE_BETA_ACCEPTED; NO_SEMANTIC_TRANSFORMATION` |
...
| Members | `/api/members` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0090` | `CANDIDATE_T1` identity fields | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member constituency status | `/api/memberelectionconstituencystatuses` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0090` | `CANDIDATE_T1`; date-state `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member region status | `/api/memberelectionregionstatuses` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0090` | `CANDIDATE_T1`; date-state `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Parties | `/api/parties` | `INTENDED_AFTER_QUALIFICATION` | `D10_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0089` | `CANDIDATE_T1` source-defined party terminology only; no affiliation, validity, or party-history claim | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0089; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0089; DAILY_TIMER_D10; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_DETAIL_OR_RELATIONSHIP_ROUTE` |
| Parties | `/api/parties/:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `CANDIDATE_T1` | `P2` | `OBSERVATION_PASS_DEC0055; HANDLING_REQUIRED` |
| Member parties | `/api/memberparties` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0090` | `CANDIDATE_T1`; point-in-time party `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member party roles | `/api/memberpartyroles` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0090` | `CANDIDATE_T1`; point-in-time role `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member government roles | `/api/membergovernmentroles` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0090` | `CANDIDATE_T1`; point-in-time role `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Committees | `/api/committees` | `INTENDED_AFTER_QUALIFICATION` | `D12_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0091` | `CANDIDATE_T1`; no membership/assignment inference | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0091; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0091; DAILY_TIMER_D12; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| MQA event types | `/api/motionsquestionsanswerseventtypes` | `D13_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0092` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0092; DAILY_TIMER_D13; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_EVENT_SEMANTICS` |
...
| MQA event subtypes | `/api/motionsquestionsanswerseventsubtypes` | `D14_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0093` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0093; DAILY_TIMER_D14; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_EVENT_SEMANTICS` |
...
| MQA event links | `/api/motionsquestionsanswerseventlinks` | `D13_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0092` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0092; DAILY_TIMER_D13; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_LINK_SEMANTICS` |
...
| MQA business motions | `/api/MotionsQuestionsAnswersMotionsBusiness?motionfilter=consideration` | `D15_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0094` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0094; DAILY_TIMER_D15; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_BUSINESS_MOTION_OR_VOTE_SEMANTICS` |
| MQA business motions | `/api/MotionsQuestionsAnswersMotionsBusiness?motionfilter=programme` | `D16_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0095` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0095; DAILY_TIMER_D16; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; NO_BUSINESS_MOTION_OR_VOTE_SEMANTICS` |
...
| MQA questions | `/api/motionsquestionsanswersquestions?year=:year` | `D17_2026_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0096` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `2026_INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0096; DAILY_TIMER_D17; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; ANNUAL_WINDOW_MECHANISM_REUSABLE_BY_LATER_NAMED_DECISION` |
...
| Committee official reports | `/api/orscommitteemeeting?year=:year` | `INTENDED_AFTER_QUALIFICATION` | `D19_2025_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0098; D20_REMAINING_YEARS_PROPOSED_DEC0099` | `DEFERRED_TIER3_PLUS; NO_CURRENT_ANALYTICAL_T1_T2` | `P4` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; D19_2025_STREAMING_RESTRICTED_HANDLING_PASS; WEEKLY_2025_RECONCILIATION; D20_REMAINING_YEARS_REQUIRES_OWNER_APPROVAL; NO_SEMANTIC_OR_DB2_CLAIM` |
...
| Plenary official reports | `/api/orsplenarymeeting?year=:year` | `INTENDED_AFTER_QUALIFICATION` | `D19_2025_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_OWNER_ACCEPTED_DEC0098; D20_REMAINING_YEARS_PROPOSED_DEC0099` | `DEFERRED_TIER3_PLUS; NO_CURRENT_ANALYTICAL_T1_T2` | `P4` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; D19_2025_STREAMING_RESTRICTED_HANDLING_PASS; WEEKLY_2025_RECONCILIATION; D20_REMAINING_YEARS_REQUIRES_OWNER_APPROVAL; NO_SEMANTIC_OR_DB2_CLAIM` |
...
| Votes on motions | `/api/votesmotion?year=:year` | `D17_2026_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0096` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_BILL_AMENDMENT_OR_STAGE_VOTE_CLAIM` | `P4` | `2026_INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0096; DAILY_TIMER_D17; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTED; DOWNLOAD_STYLE_SOURCE_MEDIA_TYPE_PRESERVED; NO_BILL_AMENDMENT_OR_STAGE_VOTE_CLAIM; ANNUAL_WINDOW_MECHANISM_REUSABLE_BY_LATER_NAMED_DECISION` |
