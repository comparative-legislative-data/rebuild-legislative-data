...
| Committee roles | `/api/committeeroles` | `INTENDED_AFTER_QUALIFICATION` | `D8_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0087` | `CANDIDATE_T1` source-defined role terminology only; no committee-membership/history claim | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0087; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0087; DAILY_TIMER_D8; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_ROUTE` |
