...
| Members | `/api/members` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0090` | `CANDIDATE_T1` identity fields | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member constituency status | `/api/memberelectionconstituencystatuses` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0090` | `CANDIDATE_T1`; date-state `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member region status | `/api/memberelectionregionstatuses` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0090` | `CANDIDATE_T1`; date-state `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member parties | `/api/memberparties` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0090` | `CANDIDATE_T1`; point-in-time party `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member party roles | `/api/memberpartyroles` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0090` | `CANDIDATE_T1`; point-in-time role `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
...
| Member government roles | `/api/membergovernmentroles` | `INTENDED_AFTER_QUALIFICATION` | `D11_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_PENDING_OWNER_ACCEPTANCE_DEC0090` | `CANDIDATE_T1`; point-in-time role `CANDIDATE_T2` only after interval rules | `P2` | `OBSERVATION_PASS_DEC0055; RESTRICTED_ROUTE_HANDLING_DEC0090; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0090; DAILY_TIMER_D11; SOURCE_PRESERVING; NO_DETAIL_OR_RELATIONSHIP_INTERPRETATION` |
