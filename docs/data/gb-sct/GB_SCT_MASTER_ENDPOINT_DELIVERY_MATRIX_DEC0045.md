...
| Government roles | `/api/governmentroles` | `INTENDED_AFTER_QUALIFICATION` | `RESTRICTED_COLLECTION_PROPOSED_DEC0086` | `CANDIDATE_T1` source-defined role terminology only; no ministerial occupancy/history claim | `P2` | `OBSERVATION_PASS_DEC0055; NOTES_HANDLING_CURRENTLY_BLOCKED; COMBINED_RESTRICTED_D7_PROPOSAL_DEC0086; NO_DETAIL_OR_RELATIONSHIP_ROUTE` |
