...
| MQA business motions | `/api/MotionsQuestionsAnswersMotionsBusiness?motionfilter=programme` | `PROPOSED_D16_DEC0095` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; ROUTE_SPECIFIC_4_MIB_GATE_PROPOSED_DEC0095; OWNER_APPROVAL_REQUIRED` |
