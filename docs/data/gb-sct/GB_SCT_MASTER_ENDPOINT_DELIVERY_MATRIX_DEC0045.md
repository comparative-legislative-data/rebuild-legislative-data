...
| MQA event types | `/api/motionsquestionsanswerseventtypes` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; HANDLING_REQUIRED` |
| MQA event types | `/api/motionsquestionsanswerseventtypes/:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `DETAIL_OBSERVATION_PASS_DEC0055; HANDLING_REQUIRED` |
...
| MQA event links | `/api/motionsquestionsanswerseventlinks` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; HANDLING_REQUIRED` |
| MQA event links | `/api/motionsquestionsanswerseventlinks?childUniqueId=:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `FILTER_OBSERVATION_PASS_DEC0055; HANDLING_REQUIRED` |
| MQA event links | `/api/motionsquestionsanswerseventlinks?mainUniqueId=:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `FILTER_OBSERVATION_PASS_DEC0055; HANDLING_REQUIRED` |
| MQA event links | `/api/motionsquestionsanswerseventlinks?parentUniqueId=:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `FILTER_OBSERVATION_PASS_DEC0055; HANDLING_REQUIRED` |
| MQA motions | `/api/motionsquestionsanswersmotions` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; HANDLING_REQUIRED` |
...
| MQA business motions | `/api/MotionsQuestionsAnswersMotionsBusiness?motionfilter=consideration` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; HANDLING_REQUIRED` |
| MQA business motions | `/api/MotionsQuestionsAnswersMotionsBusiness?motionfilter=programme` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; HANDLING_REQUIRED` |
| MQA questions | `/api/motionsquestionsanswersquestions` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_LATENCY_PROFILE_PASS_DEC0055; HANDLING_REQUIRED` |
...
| MQA questions | `/api/motionsquestionsanswersquestions?year=:year` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `YEAR_FORM_FULL_RESPONSE_AUDIT_PASS_DEC0055; HANDLING_REQUIRED` |
| MQA supports | `/api/motionsquestionsanswerssupports` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_LATENCY_PROFILE_PASS_DEC0055; HANDLING_REQUIRED` |
...
| Committee official reports | `/api/Orscommitteemeeting/:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `DEFERRED_TIER3_PLUS; NO_CURRENT_ANALYTICAL_T1_T2` | `P4` | `DETAIL_EMPTY_OBJECT_200_OBSERVED_DEC0055; HANDLING_REQUIRED` |
| Committee official reports | `/api/orscommitteemeeting?year=:year` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `DEFERRED_TIER3_PLUS; NO_CURRENT_ANALYTICAL_T1_T2` | `P4` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; HANDLING_REQUIRED` |
| Plenary official reports | `/api/orsplenarymeeting/:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `DEFERRED_TIER3_PLUS; NO_CURRENT_ANALYTICAL_T1_T2` | `P4` | `DETAIL_EMPTY_OBJECT_200_OBSERVED_DEC0055; HANDLING_REQUIRED` |
| Plenary official reports | `/api/orsplenarymeeting?year=:year` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `DEFERRED_TIER3_PLUS; NO_CURRENT_ANALYTICAL_T1_T2` | `P4` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; HANDLING_REQUIRED` |
| Votes on motions | `/api/votesmotion/:id` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_BILL_AMENDMENT_OR_STAGE_VOTE_CLAIM` | `P4` | `DETAIL_EMPTY_OBJECT_200_OBSERVED_DEC0055; HANDLING_REQUIRED` |
| Votes on motions | `/api/votesmotion?year=:year` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_BILL_AMENDMENT_OR_STAGE_VOTE_CLAIM` | `P4` | `FULL_RESPONSE_AUDIT_PASS_DEC0055; HANDLING_REQUIRED` |
