...
| MQA event types | `/api/motionsquestionsanswerseventtypes` | `D13_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0092` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0092; DAILY_TIMER_D13; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTANCE_PENDING; NO_EVENT_SEMANTICS` |
...
| MQA event links | `/api/motionsquestionsanswerseventlinks` | `D13_RESTRICTED_CAPTURE_RECONCILIATION_PROJECTION_PRIVATE_ACCESS_PASS_DEC0092` | `INCLUDED` | `FUTURE_T1_FIELD_ASSESSMENT; NO_CURRENT_BILL_T1_T2` | `P3` | `COLLECTION_PROFILE_PASS_DEC0055; INITIAL_AND_IMMEDIATE_RECONCILIATION_PASS_DEC0092; DAILY_TIMER_D13; SOURCE_PRESERVING; PRIVATE_BETA_ACCEPTANCE_PENDING; NO_LINK_SEMANTICS` |
