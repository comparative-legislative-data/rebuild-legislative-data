...
| Formal stages | `/api/billstages` | `INTENDED_AFTER_QUALIFICATION` | `INCLUDED` | `CANDIDATE_T1`; possible `CANDIDATE_T2` ordering only after rules | `P1` | `OBSERVATION_PASS; HANDLING_REQUIRED; WORK_PACKAGE_STOPPED_DEC0054; CONTRACT_OBSERVED_PENDING_HANDLING_AND_TERMS_DEC0070` |
