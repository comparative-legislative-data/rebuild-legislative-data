...
- [Proposed final initial DB1 response-unit model](GB_SCT_FINAL_INITIAL_DB1_RESPONSE_UNIT_MODEL_2026-08-06.md)
...
design direction, but DB1 source work remains blocked until the owner approves
the response-unit matrix and a separate implementation package.
