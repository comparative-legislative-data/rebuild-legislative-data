...
## 4. Implication for later DB1 work
...
Complete representative full audits of the remaining high-volume MQA route
forms and the older/current endpoints of the report/votes annual forms. Then
produce one route-by-route operational profile, clearly separating full audit,
transport-only profile, and still-unobserved forms.
