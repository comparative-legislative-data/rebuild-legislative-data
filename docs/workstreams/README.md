...
| [DB1](db1/README.md) | Retained, source-preserving responses and researcher access tools, each tied to a capture and manifest. | Significant private coverage exists; the Database mirror’s private directory and endpoint workspace are deployed. Its next work is a separately approved researcher-access expansion, not DB2. |
