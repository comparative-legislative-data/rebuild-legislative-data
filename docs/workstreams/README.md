...
| [Database mirror](db1/README.md) | A PostgreSQL-based mirror of approved Scottish Parliament API responses. | The 117-response baseline and complete byte-level recheck passed; routine reconciliation is enabled. Recovery is deliberately deferred; a researcher portal requires a separate design package. |
