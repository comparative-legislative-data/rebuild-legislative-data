...
[D13 — DEC-0092](../../data/gb-sct/GB_SCT_DB1_MQA_TAXONOMY_LINK_COLLECTION_BATCH_RESULT_DEC0092_2026-08-04.md), [D14 — DEC-0093](../../data/gb-sct/GB_SCT_DB1_MQA_EVENT_SUBTYPES_COLLECTION_COHORT_RESULT_DEC0093_2026-08-04.md), and [D15 — DEC-0094](../../data/gb-sct/GB_SCT_DB1_MQA_BUSINESS_CONSIDERATION_COHORT_RESULT_DEC0094_2026-08-04.md) are closed source-preserving increments in the shared MQA category. D13 retains Event types and Event links; D14 retains 18 Event-subtype objects; D15 retains 1,461 objects from the literal source-defined `motionfilter=consideration` response. Each has initial/immediate unchanged evidence, its own daily reconciliation position, fixed pagination, and owner interface acceptance. None assigns MQA, business-motion, bill, stage, vote, or amendment semantics. The next proposed increment, [D16 — DEC-0095](../../data/gb-sct/GB_SCT_DB1_MQA_BUSINESS_PROGRAMME_COHORT_PROPOSAL_DEC0095.md), would test the other fixed business-motion filter under a route-specific 4 MiB gate; it requires explicit owner approval before any action.
