...
| DEC-0007 | Approve the complete GB-SCT endpoint inventory and variable roadmap. | `PROPOSED` | Project design §§6, 8, 12; endpoint-inventory model approved by the owner (31 July 2026). | Requires retained assessment evidence and exact endpoint, native-access, DB1, Tier 1/2, deferred-variable, and exclusion records. It does not authorise capture or implementation. |
