...
| DEC-0007 | Define the first GB-SCT source slice and its success criteria. | `PROPOSED` | Project design §§8, 12. | Requires retained assessment evidence from an approved DEC-0013 reconnaissance action and explicit owner approval before any capture proposal. |
...
| DEC-0013 | Approve a bounded GB-SCT source-reconnaissance action. | `PROPOSED` | Phase A planning pack. | Requires named targets, permitted inspection actions, limits, evidence to retain, stop conditions, and success criteria. It must not authorise raw capture, ingestion, database work, or publication. |
