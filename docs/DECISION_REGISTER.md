...
| DEC-0006 | Approve the project-design draft, or request revisions. | `PROPOSED` | Project design status and §12; handover “Recommended immediate next action”. | Owner review required before implementation planning advances. |
