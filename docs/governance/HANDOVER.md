...
is owner-approved and in progress: a first source-backed DB1 projection and
private explorer. The proxy and DB1 are independent data pipes sharing only
the application/authentication gateway.
