import { runFullScopeMqaCollections } from "../apps/api/dist/db1/full-scope.js";
...
process.stdout.write(`${JSON.stringify(await runFullScopeMqaCollections({ databaseUrl, rawRoot, codeRevision }))}\n`);
