import { migrateD4ReferenceReconciliation } from "../apps/api/dist/db1/foundation.js";
...
await migrateD4ReferenceReconciliation({
  databaseUrl,
  rawRoot,
  migrationRole: process.env.CLD_DB1_MIGRATION_ROLE || "cld_gb_sct_migrate"
});
process.stdout.write("D4 reference-reconciliation migration passed.\n");
