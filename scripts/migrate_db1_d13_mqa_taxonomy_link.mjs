import { migrateD13MqaTaxonomyLink } from "../apps/api/dist/db1/foundation.js";

const databaseUrl = process.env.CLD_DB1_DATABASE_URL;
const rawRoot = process.env.CLD_DB1_RAW_ROOT;
const migrationRole = process.env.CLD_DB1_MIGRATION_ROLE;
...
await migrateD13MqaTaxonomyLink({ databaseUrl, rawRoot, migrationRole });
