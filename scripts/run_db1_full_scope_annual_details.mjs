import { runFullScopeAnnualDetails } from "../apps/api/dist/db1/full-scope.js";
...
process.stdout.write(`${JSON.stringify(await runFullScopeAnnualDetails({ databaseUrl, rawRoot, codeRevision }))}\n`);
