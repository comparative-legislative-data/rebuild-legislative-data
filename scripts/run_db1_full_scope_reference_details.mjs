import { runFullScopeReferenceDetails } from "../apps/api/dist/db1/full-scope.js";
...
process.stdout.write(`${JSON.stringify(await runFullScopeReferenceDetails({ databaseUrl, rawRoot, codeRevision }))}\n`);
