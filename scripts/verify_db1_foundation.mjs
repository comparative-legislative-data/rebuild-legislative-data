...
for (const route of ["/db1/gb-sct/bill-types/d2-v1", "/db1/gb-sct/reference-cohort/d4a-v1", "/db1/gb-sct/institutional-reference/d4c-v1", "/db1/gb-sct/formal-stages/d5-v1", "/db1/gb-sct/bills/d6-v1", "/db1/gb-sct/government-roles/d7-v1", "/db1/gb-sct/committee-roles/d8-v1", "/db1/gb-sct/party-roles/d9-v1", "/db1/gb-sct/parties/d10-v1"]) {
...
if (declaredDb1Routes.length !== 18 || declaredDb1Routes.some((route) => !["/db1/gb-sct/bill-types/d2-v1", "/db1/gb-sct/reference-cohort/d4a-v1", "/db1/gb-sct/institutional-reference/d4c-v1", "/db1/gb-sct/formal-stages/d5-v1", "/db1/gb-sct/bills/d6-v1", "/db1/gb-sct/government-roles/d7-v1", "/db1/gb-sct/committee-roles/d8-v1", "/db1/gb-sct/party-roles/d9-v1", "/db1/gb-sct/parties/d10-v1"].includes(route))) throw new Error("access routes: generic DB1 route is prohibited");
for (const route of ["https://data.parliament.scot/api/billtypes", "https://data.parliament.scot/api/billstagetypes", "https://data.parliament.scot/api/sessions", "https://data.parliament.scot/api/constituencies", "https://data.parliament.scot/api/regions", "https://data.parliament.scot/api/committeetypes", "https://data.parliament.scot/api/committeetypelinks", "https://data.parliament.scot/api/billstages", "https://data.parliament.scot/api/bills", "https://data.parliament.scot/api/governmentroles", "https://data.parliament.scot/api/committeeroles", "https://data.parliament.scot/api/partyroles", "https://data.parliament.scot/api/parties"]) {
...
process.stdout.write("DB1 capability scan passed: D1 foundation, fixed D2/D4/D4C/D5/D6/D7/D8/D9/D10 capture routes, fixed reader routes; no generic DB1 route.\n");
