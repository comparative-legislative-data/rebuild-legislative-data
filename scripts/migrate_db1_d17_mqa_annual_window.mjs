import { migrateD17MqaAnnualWindow } from "../apps/api/dist/db1/foundation.js";
...
await migrateD17MqaAnnualWindow({ databaseUrl, rawRoot, migrationRole: process.env.CLD_DB1_MIGRATION_ROLE });
