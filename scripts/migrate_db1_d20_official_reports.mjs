import { migrateD20OfficialReports } from "../apps/api/dist/db1/foundation.js";
...
await migrateD20OfficialReports({ databaseUrl, rawRoot, migrationRole: process.env.CLD_DB1_MIGRATION_ROLE });
