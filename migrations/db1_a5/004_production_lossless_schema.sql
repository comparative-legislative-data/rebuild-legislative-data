...
GRANT SELECT ON db1.source_form, db1.response_unit, db1.capture_run, db1.source_response, db1.projection_run, db1.response_object, db1.v_current_response_unit TO cld_gb_sct_db1_worker;
...
GRANT UPDATE (finished_at, result_status, observed_shape, object_count, detail) ON db1.projection_run TO cld_gb_sct_db1_worker;
