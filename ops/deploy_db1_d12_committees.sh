...
sed \
  -e 's/for timer in d4a d4c d5 d6 d7; do/for timer in d4a d4c d5 d6 d7 d8 d9 d10 d11 d12; do/' \
  -e 's/for timer in d4a d4c d5 d6 d7 d8; do/for timer in d4a d4c d5 d6 d7 d8 d9 d10 d11 d12; do/' \
  -e 's/d8/d12/g' \
  -e 's/D8/D12/g' \
