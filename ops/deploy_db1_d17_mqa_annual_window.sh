...
sed \
  ...
  gb-sct.mqa-questions-2026.collection\
  gb-sct.votes-on-motions-2026.collection' \
  -e 's/for timer in d4a d4c d5 d6 d7 d8 d9 d10; do/for timer in d4a d4c d5 d6 d7 d8 d9 d10 KEEP_ELEVEN d12 d13 d14 d15 d16; do/' \
  -e 's/for timer in d4a d4c d5 d6 d7 d8 d9 d10 d11; do/for timer in d4a d4c d5 d6 d7 d8 d9 d10 KEEP_ELEVEN d12 d13 d14 d15 d16 d17; do/' \
  -e 's/for path in members member-constituency-statuses member-region-statuses member-parties member-party-roles member-government-roles; do/for path in mqa-questions-2026 votes-on-motions-2026; do/' \
  -e 's/\[\[ "\$release_count" == "6" \]\]/[[ "$release_count" == "2" ]]/' \
  -e 's/d11/d17/g' -e 's/D11/D17/g' \
